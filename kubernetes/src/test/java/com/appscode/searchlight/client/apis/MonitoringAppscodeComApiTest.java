...
/**
 * API tests for MonitoringAppscodeComApi
 */
@Ignore
public class MonitoringAppscodeComApiTest {

    private final MonitoringAppscodeComApi api = new MonitoringAppscodeComApi();
