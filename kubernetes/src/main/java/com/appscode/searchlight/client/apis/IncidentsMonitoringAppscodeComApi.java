...
public class IncidentsMonitoringAppscodeComApi {
    private ApiClient apiClient;

    public IncidentsMonitoringAppscodeComApi() {
        this(Configuration.getDefaultApiClient());
    }

    public IncidentsMonitoringAppscodeComApi(ApiClient apiClient) {
    ...
    public com.squareup.okhttp.Call getAPIGroupCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/apis/incidents.monitoring.appscode.com/";
